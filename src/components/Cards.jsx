...
function Cards({ blogs }) {
    return (
        <>
            {blogs.map((val, index) => (
                <div key={index} className="card w-64 m-2 shadow-md hover:shadow-gray-200 rounded-2xl">
                    <img src={val.image} alt={val.title} className="h-1/2 border-t-1 rounded-t-2xl" />
